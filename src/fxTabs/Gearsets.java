...
public class Gearsets {
	...
	public static void updateContent() {
		...
		Text[] headers = {new Text("Slot"),new Text("Name"), new Text("Enchantments"), new Text("Crafting"), new Text("Set")};
		...
		for(GearSlot slot : GearSlot.values()) {
			...
			grid.addRow((row++), new Text(slot.displayName()), name, enchantments, bSelect);
		}
	}
}
